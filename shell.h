...
/**
 * struct passinfo - contains pseudo-arguements to pass into a func
 ...
 * @history: hist node
 * @alias: alias node
 * @env_changed: only if env was changed
 * @status: return status of the last exec command
 * @cmd_buf: address of pointer to cmd_buf, only if chaining
 * @cmd_buf_type: CMD_type ||, &&, ;
 * @readfd: fd from which to read line input
 * @histcount: hist line no. count
 */
...
/**
 * struct builtin - contains builtin string and the related func
 *
